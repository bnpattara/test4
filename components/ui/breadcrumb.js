...
const Breadcrumb = React.forwardRef(({ ...props }, ref) => (
  <BreadcrumbPrimitive.Root
    ref={ref}
    className="flex break-words text-sm text-muted-foreground sm:text-base"
    {...props}
  />
))
...
const BreadcrumbList = React.forwardRef(({ className, ...props }, ref) => (
  <ol
    ref={ref}
    className={cn(
      "flex flex-wrap items-center gap-1.5 break-words md:gap-2.5",
      className
    )}
    {...props}
  />
...
const BreadcrumbEllipsis = ({ className, ...props }) => (
  <span
    ...
    {...props}
  >
    <BreadcrumbPrimitive.Ellipsis className="h-4 w-4" />
    <span className="sr-only">More</span>
  </span>
)
BreadcrumbEllipsis.displayName = "BreadcrumbPrimitive.Ellipsis"
